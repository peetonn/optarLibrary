...
public:
     ...
     * @return -1 if the texture was not processed in this call (rate throttling), 0 otherwise
     */
    int processTexture(int w, int h, const void *rgbaData,
                        int &nKeyPoints,
     ...
     * @return -1 if the texture was not processed in this call (rate throttling), 0 otherwise
     */
    int processTexture(int w, int h, int yStride,
                        const void *yuvData,
                        int &nKeyPoints,
                        CameraIntrinsics cameraIntrinsics,
                        bool debugSaveImage = false,
