...
public:
    ...
    int processTexture(const Mat &img,
                        int &nKeypoints,
                            ...
                            Point2D **keypointsOut)
{
    ...
    return pimpl_->processTexture(imgWrapper, nKeypoints, cameraIntrinsics, keypointsOut, debugSaveImage);
}
...
//    cvtColor(imgYV12, imgDest, COLOR_YUV2GRAY_Y422);
    ...
    return pimpl_->processTexture(imgDest, nKeyPoints, cameraIntrinsics, keyPoints, debugSaveImage);
}
